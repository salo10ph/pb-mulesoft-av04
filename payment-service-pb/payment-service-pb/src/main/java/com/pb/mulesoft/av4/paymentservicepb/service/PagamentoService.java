...
import com.pb.mulesoft.av4.paymentservicepb.model.InformacoesDePagamento;
...
public class PagamentoService {
    ...
    public PagamentoDto criar(@Valid PagamentoForm form) {
		...
		InformacoesDePagamento informacoesDePagamento = form.getPayment();
		
		Cartao cartao = new Cartao(informacoesDePagamento.getCard_number(), informacoesDePagamento.getCardholder_name(), informacoesDePagamento.getSecurity_code(), informacoesDePagamento.getBrand(), informacoesDePagamento.getExpiration_month(), informacoesDePagamento.getExpiration_year());
		...
		return new PagamentoDto(salvo.getOrder_id(), salvo.getTotal(), salvo.getPayment_id(), salvo.getPayment_status(), salvo.getMessage());
